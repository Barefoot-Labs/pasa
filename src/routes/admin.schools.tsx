          ...
          <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={onCreate} className="space-y-4">
              <div className="grid grid-cols-2 gap-3">
                ...
                <div><Label htmlFor="s-district-text">District (text)</Label><Input id="s-district-text" name="district" required placeholder="e.g. Metro Central" /></div>
                <div>
                  <Label>Province</Label>
                  <Select value={province} onValueChange={(v) => { setProvince(v); setDistrictId(""); }}>
